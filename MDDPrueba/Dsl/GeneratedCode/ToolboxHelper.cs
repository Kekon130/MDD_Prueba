...
namespace IPS.NodosTelefonia
{
	...
	/// </remarks>
	public partial class NodosTelefoniaToolboxHelper : NodosTelefoniaToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new NodosTelefoniaToolboxHelper.
		/// </summary>
		public NodosTelefoniaToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class NodosTelefoniaToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify NodosTelefonia toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "NodosTelefonia.1.0";
		...
		/// <summary>
		/// Constructs a new NodosTelefoniaToolboxHelperBase.
		/// </summary>
		protected NodosTelefoniaToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::IPS.NodosTelefonia.NodosTelefoniaDomainModel.SingletonResourceManager.GetString("NodosTelefoniaToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::IPS.NodosTelefonia.NodosTelefoniaDomainModel.SingletonResourceManager;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::IPS.NodosTelefonia.NodosTelefoniaDomainModel));
