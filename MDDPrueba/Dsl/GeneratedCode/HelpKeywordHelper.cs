...
namespace IPS.NodosTelefonia
{
	...
	/// </remarks>
	public partial class NodosTelefoniaHelpKeywordHelper : NodosTelefoniaHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new NodosTelefoniaHelpKeywordHelper.
		/// </summary>
		protected NodosTelefoniaHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the NodosTelefoniaHelpKeywordHelper.
		/// </summary>
		public static NodosTelefoniaHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class NodosTelefoniaHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new NodosTelefoniaHelpKeywordHelperBase.
		/// </summary>
		protected NodosTelefoniaHelpKeywordHelperBase()
			: base() { }
