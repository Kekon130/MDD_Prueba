...
namespace IPS.NodosTelefonia
{
	...
	/// </summary>
	internal partial class NodosTelefoniaCommandSet : NodosTelefoniaCommandSetBase
	{
		/// <summary>
		/// Constructs a new NodosTelefoniaCommandSet.
		/// </summary>
		public NodosTelefoniaCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class NodosTelefoniaCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new NodosTelefoniaCommandSetBase.
		/// </summary>
		protected NodosTelefoniaCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewNodosTelefoniaExplorerCommand,
				typeof(NodosTelefoniaEditorFactory).GUID);
		...
		{
			NodosTelefoniaExplorerToolWindow explorer = this.NodosTelefoniaExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected NodosTelefoniaDocData CurrentNodosTelefoniaDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as NodosTelefoniaDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected NodosTelefoniaDocView CurrentNodosTelefoniaDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as NodosTelefoniaDocView;
			}
		}
		...
		/// </summary>
		protected NodosTelefoniaExplorerToolWindow NodosTelefoniaExplorerToolWindow
		{
			get
			{
				NodosTelefoniaExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(NodosTelefoniaExplorerToolWindow), true) as NodosTelefoniaExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				NodosTelefoniaExplorerToolWindow explorerWindow = this.NodosTelefoniaExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class NodosTelefoniaClipboardCommandSet : NodosTelefoniaClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new NodosTelefoniaClipboardCommandSet.
		/// </summary>
		public NodosTelefoniaClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class NodosTelefoniaClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new NodosTelefoniaClipboardCommandSetBase.
		/// </summary>
		protected NodosTelefoniaClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
