...
namespace IPS.NodosTelefonia
{
	...
	/// </summary>
	internal partial class NodosTelefoniaDocView : NodosTelefoniaDocViewBase
	{
		/// <summary>
		/// Constructs a new NodosTelefoniaDocView.
		/// </summary>
		public NodosTelefoniaDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class NodosTelefoniaDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new NodosTelefoniaDocView.
		/// </summary>
		protected NodosTelefoniaDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			NodosTelefoniaDocDataBase docData = this.DocData as NodosTelefoniaDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for NodosTelefoniaDocViewBase should be an NodosTelefoniaDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::IPS.NodosTelefonia.NodosTelefoniaDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::IPS.NodosTelefonia.NodosTelefoniaDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::IPS.NodosTelefonia.NodosTelefoniaToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::IPS.NodosTelefonia.NodosTelefoniaToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.NodosTelefoniaDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::IPS.NodosTelefonia.NodosTelefoniaHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::IPS.NodosTelefonia.NodosTelefoniaHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::IPS.NodosTelefonia.NodosTelefoniaHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
