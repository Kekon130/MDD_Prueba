...
namespace IPS.NodosTelefonia
{
	...
	/// </summary>
	internal partial class NodosTelefoniaDocData : NodosTelefoniaDocDataBase
	{
		/// <summary>
		/// Constructs a new NodosTelefoniaDocData.
		/// </summary>
		public NodosTelefoniaDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a NodosTelefonia document in memory.
	/// </summary>
	internal abstract partial class NodosTelefoniaDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new NodosTelefoniaDocDataBase.
		/// </summary>
		protected NodosTelefoniaDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::IPS.NodosTelefonia.NodosTelefoniaDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::IPS.NodosTelefonia.NodosTelefoniaDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::IPS.NodosTelefonia.NodosTelefoniaDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::IPS.NodosTelefonia.NodosTelefoniaDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::IPS.NodosTelefonia.TapizNodos modelRoot = null;
			...
			global::IPS.NodosTelefonia.NodosTelefoniaDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::IPS.NodosTelefonia.NodosTelefoniaSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::IPS.NodosTelefonia.NodosTelefoniaDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::IPS.NodosTelefonia.NodosTelefoniaDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::IPS.NodosTelefonia.TapizNodos modelRoot = (global::IPS.NodosTelefonia.TapizNodos)this.RootElement;
			...
			{
				global::IPS.NodosTelefonia.NodosTelefoniaDiagram diagram = diagrams[0] as global::IPS.NodosTelefonia.NodosTelefoniaDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::IPS.NodosTelefonia.NodosTelefoniaSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::IPS.NodosTelefonia.NodosTelefoniaSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::IPS.NodosTelefonia.NodosTelefoniaDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::IPS.NodosTelefonia.NodosTelefoniaSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::IPS.NodosTelefonia.TapizNodos modelRoot = this.RootElement as global::IPS.NodosTelefonia.TapizNodos;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::IPS.NodosTelefonia.NodosTelefoniaSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
